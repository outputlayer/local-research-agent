...
EXPLORER_PROMPT = (
    ...
    "• ОБЯЗАТЕЛЬНО для КАЖДОЙ взятой в notes статьи и репо вызови kb_add с kind='paper'|'repo', "
    "id, claim (1-3 предложения сути), title, опционально authors/url/stars/lang. "
    "Это структурированная база знаний для поиска на следующих итерациях.\n"
